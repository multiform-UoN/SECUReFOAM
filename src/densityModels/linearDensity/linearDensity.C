...
densityModels::linearDensity::linearDensity
(
...
tmp<scalarField> densityModels::linearDensity::rho(const scalarField& C)
{
  tmp<scalarField> tf
  (
...
tmp<scalarField> densityModels::linearDensity::drhodC(const scalarField& C)
{
  tmp<scalarField> tf
  (
      new scalarField(C.size(),beta_)
  );
...
void
densityModels::linearDensity::write(Ostream& os) const
{
